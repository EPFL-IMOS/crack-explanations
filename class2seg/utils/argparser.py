...
def get_parser():
    ...
    parser.add('--arg_log', default=True, type=str2bool, help='save arguments to config file')

    # Dataset parameters
    parser.add_argument('--dataset', choices=['DICCracksDataset', 'MagneticTilesDataset'], type=str, help='which dataset to use')
    parser.add_argument('--num_classes', default=2, type=int, help='number of classes')
    parser.add_argument('--data_path', default='../datasets/', type=str, help='path of the dataset')
    ...
    parser.add_argument('--fix_classifier_backbone', default=True, type=str2bool, help='Whether to fix the weights for the classifiers backbone')
    ...
    parser.add_argument('--classifier_type', choices=['vgg11', 'vgg11_128', 'vgg11_bn', 'vgg11_bn_128', 'vgg11_bcos', 'vgg11_bcos_128', 'resnet18', 'resnet50'], default='vgg11_128', type=str, help='type of classifier architecture to use')
    ...
    parser.add_argument('--explainer_type', choices=['unet11', 'unet16', 'deeplabv3'], default='unet11', type=str, help='type of explainer architecture to use')

    # Model-specific parameters
    parser.add_argument('--learning_rate', default=1e-5, type=float, help='learning rate used by the Adam optimizer')
    parser.add_argument('--use_inverse_classification_loss', default=True, type=str2bool, help='whether to use classification loss on the inversed mask.')
    ...
    parser.add_argument('--output_dir', default='./output/nn-explainer/', type=str, help='output dir')
    parser.add_argument('--eval_fold', choices=['train', 'val', 'test'], default='test', type=str, help='dataset fold used for evaluation and saving masks')
